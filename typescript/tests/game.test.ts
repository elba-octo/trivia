...
class GameTest extends Game {
  ...
  public getPopQuestions(): Array<Question> {
    return this.popQuestions;
  }

  public getScienceQuestions(): Array<Question> {
    return this.scienceQuestions;
  }

  public getSportsQuestions(): Array<Question> {
    return this.sportsQuestions;
  }

  public getRockQuestions(): Array<Question> {
